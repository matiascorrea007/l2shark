        ...
        <div class="content">
            ...
            <div class="panel well well-sm">
                <div class="panel-body">
                    <div class="col-md-12">
                        <div class="col-md-6">
                           <p> <strong>Usuario :</strong> {{ $ticket->user->login }}</p>
...
<div class="panel panel-default">
		<div class="panel-heading">
   		 	<h3 class="panel-title">{{$comentario->user->login}}<div class="pull-right">
        {{$comentario->created_at}}</div></h3>
 		</div>	
  <div class="panel-body">
<div class="row">
...
<div class="form-horizontal col-xs-12 col-sm-12 col-md-12">
	{!!Form::label('')!!}
	{!!Form::textarea ('comentario',null,['class'=>'form-control','placeholder'=>'ingrese la observacion'])!!}
</div>
<br>
</div>
</div>
