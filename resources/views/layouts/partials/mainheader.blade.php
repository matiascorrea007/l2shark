...
<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        ...
        <span class="logo-mini"><b>S</b>HARK</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Admin</b> Shark</span>
    </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                  ...
                                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Edit-{{ Auth::user()->id }}"><i class="fa fa-edit"> Editar</i></button>
