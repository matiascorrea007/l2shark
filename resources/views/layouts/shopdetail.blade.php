...
<meta property="fb:app_id"          content="304809906559120" /> 
<meta property="og:type"            content="article" /> 
<meta property="og:url"             content="http://sharkinformatica.com/item-detalle-{{ $itemdetalle->slug }}" /> 
<meta property="og:title"           content="{{ $itemdetalle->descripcion }}" /> 
<meta property="og:image"           content="http://sharkinformatica.com/{{ $urlimagen }}" /> 
<meta property="og:image:width"           content="600" /> 
<meta property="og:image:height"           content="600" /> 

<meta property="og:description"    content="${!! $itemdetalle->precioventa !!}" />
    ...
    <li class="yamm-content">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-lg-4">
                <ul class="links list-unstyled"><li><a href="subcategoria-{{$subcategoria->slug}}">{{ $subcategoria->nombre }}</a></li>
                </ul>  
