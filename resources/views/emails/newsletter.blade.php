...
<a onclick="return checkLinkHref(this.href);" target="_blank" href="http://sharkinformatica.com/" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #9b9b9b; font-family: Helvetica, Arial, sans-serif; font-size: 11px; font-weight: normal; padding: 0; text-align: center; text-decoration: none;">Versión online</a>
...
<strong>HOLA </strong> {{ $user->nombre }} {{ $user->apellido }} te traemos las ultimas novedades de Sharkinfomatica , esperamos tu visita
</td>
</tr>
